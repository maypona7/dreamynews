  ...
  return (
    <Modal>
      <div className="space-y-4 animate-pulse">
        ...
        <div className="h-9 w-2/3 rounded bg-brand-200" />
        <div className="h-4 w-1/3 rounded bg-brand-100" />
        <div className="space-y-2 pt-2">
          <div className="h-4 w-full rounded bg-brand-100" />
          <div className="h-4 w-[92%] rounded bg-brand-100" />
          <div className="h-4 w-[80%] rounded bg-brand-100" />
          <div className="h-4 w-[70%] rounded bg-brand-100" />
        </div>
      </div>
    </Modal>
  );
